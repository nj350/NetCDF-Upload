...
#creates a file 'nc' which contains all of the extracted data from the netcdf, if netcdf4 file use nc_open and ncvar_get, this prints all files, search through a file to find the variable names of interest
for(file in files) {
 nc <- open.nc(file)
  print.nc(nc)
}
